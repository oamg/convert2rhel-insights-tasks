...
@patch('main.urlopen', return_value=MockResponse('exist_not_match'))
@patch('os.path.exists', return_value=True)
@patch('os.makedirs', side_effect=Mock())
@patch('__builtin__.open', side_effect=mock_open)
def test_setup_convert2rhel_file_exist_not_match(mock_open_fn, mock_makedirs, mock_exist, mock_urlopen):
...
@patch('main.urlopen', return_value=MockResponse('exist_match'))
@patch('os.path.exists', return_value=True)
@patch('os.makedirs', side_effect=Mock())
@patch('__builtin__.open', side_effect=mock_open)
def test_setup_convert2rhel_file_exist_match(mock_open_fn, mock_makedirs, mock_exist, mock_urlopen):
...
@patch('main.urlopen', return_value=MockResponse('not_exist'))
@patch('os.path.exists', return_value=False)
@patch('os.makedirs', side_effect=Mock())
@patch('__builtin__.open', new_callable=mock_open)
@patch('os.chmod', side_effect=Mock())
def test_setup_convert2rhel_file_not_exist(mock_chmod, mock_open_fn, mock_makedirs, mock_exist, mock_urlopen):
